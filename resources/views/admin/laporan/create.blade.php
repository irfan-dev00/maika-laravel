...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4">Tambah Laporan Penjualan</h1>
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ url('/admin/laporan') }}" class="row g-3">
                    @csrf
                    <div class="col-md-4">
                    ...
                    <div class="col-12 d-flex gap-2">
                        ...
                        <a class="btn btn-outline-secondary" href="{{ url('/admin/laporan') }}">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
